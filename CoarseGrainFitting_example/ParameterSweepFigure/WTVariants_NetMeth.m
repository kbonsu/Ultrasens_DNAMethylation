function [n,K,ED50,flag,NormW,RelE] = WTVariants_NetMeth(alpha,beta,ParSet,DistLength)
%this one varies the net methylation vs net demethylation strength. This is
%also like changing the strength of standard reactions without changing the
%relative strength of collab to standard. 

%alpha^2 - scale for net methylation
%beta^2 - scale for net demethylation
WTPar=ParSet;
...
%scale the parameters in a way that scales the net methylation /
%demethylation up and down
k9=k9*beta;
k11=k11*beta;
k2=beta*k2+(beta-1)*k14;
k4=beta*k4+(beta-1)*k13;
