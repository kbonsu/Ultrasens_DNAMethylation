function [p,SSD] = Fitting_Tues(Par0,DL0,DataName)
...
% % p0(3)=2.7378;%2.692;
% % p0(4)=0.0895;%0.0903;
% % p0(5)=18.0821;%17.6892;
% % p0=p0+randn(size(p0))*1E-3;
% % DLm=17.7367;%p(6);
% % DLu=49.3725;%p(7);
...
tag=randi(10000); %generate a random integer tag. This will be a unique identifier for the output
%from the fitting
